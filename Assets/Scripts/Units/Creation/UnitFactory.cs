...
namespace UnitWarfare.Units
{
    public static class UnitFactory
    {
        ...
        public static IUnit GenerateUnit(Territory territory, UnitData data, System.Type type, Transform unit_container, IUnitOwner unit_manager)
        {
            ...
            _ = type ?? throw new System.ArgumentException("Generated unit type not spcified.");
            ...
            IUnit unit = (IUnit)System.Activator.CreateInstance(type, args);
            return unit;
        }
            ...
            foreach (System.Type t in _unitTypes)
            {
                ...
                foreach (System.Type gt in generic_args)
                {
                    if (gt.Equals(data.GetType()))
                        return GenerateUnit(territory, data, t, unit_container, unit_manager);
                }
            }
            return null;
        }
